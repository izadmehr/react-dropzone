;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof define === 'function' && define.amd) define(['react', 'prop-types'], factory)
  else if (typeof exports === 'object')
    exports.Dropzone = factory(require('react'), require('prop-types'))
  else root.Dropzone = factory(root.react, root['prop-types'])
...
let _styles = __webpack_require__(6);

let _styles2 = _interopRequireDefault(_styles);
...
let Dropzone = function (_React$Component) {
            _inherits(Dropzone, _React$Component)

            function Dropzone(props, context) {
              _classCallCheck(this, Dropzone)

    let _this = _possibleConstructorReturn(this, (Dropzone.__proto__ || Object.getPrototypeOf(Dropzone)).call(this, props, context));
      ...
      let preventDropOnDocument = this.props.preventDropOnDocument;
      ...
      let rejectedFiles = [];
                  ...
                  fileList.forEach(function(file) {
                    ...
                    if (
                      (0, _utils.fileAccepted)(file, accept) &&
                      (0, _utils.fileMatchSize)(file, _this3.props.maxSize, _this3.props.minSize)
                    ) {
                  ...
                  if (!multiple) {
                    ...
                    rejectedFiles.push.apply(
                      rejectedFiles,
                      _toConsumableArray(acceptedFiles.splice(1))
                    )
                  }
     ...
     */
      ...
      let isMultipleAllowed = multiple || filesCount <= 1;
      let isDragAccept = filesCount > 0 && (0, _utils.allFilesAccepted)(draggedFiles, this.props.accept);
      let isDragReject = filesCount > 0 && (!isDragAccept || !isMultipleAllowed);
                  className = className || ''
                  var noStyles =
                    !className &&
                    !style &&
      ...
      let customProps = ['acceptedFiles', 'preventDropOnDocument', 'disablePreview', 'disableClick', 'activeClassName', 'acceptClassName', 'rejectClassName', 'disabledClassName', 'onDropAccepted', 'onDropRejected', 'onFileDialogCancel', 'maxSize', 'minSize'];
...
let _attrAccept = __webpack_require__(5);

let _attrAccept2 = _interopRequireDefault(_attrAccept);

        function _interopRequireDefault(obj) {
          return obj && obj.__esModule ? obj : { default: obj }
        }

let supportMultiple = exports.supportMultiple = typeof document !== 'undefined' && document && document.createElement ? 'multiple' in document.createElement('input') : true;
                ...
                for (a in r)
                  (p = !(t & s.F) && v && a in v),
                    ...
                    (y =
                      t & s.B && p
                        ? f(l, e)
                        : h && 'function' == typeof l ? f(Function.call, l) : l),
                    v && !p && u(v, a, l),
                    x[a] != l && i(x, a, y),
                    h && ((x[c] || (x[c] = {}))[a] = l)
              }
          ...
          function(t, n, r) {
            ...
            ;(r(1).inspectSource = function(t) {
              ...
              (t.exports = function(t, n, r, u) {
                'function' == typeof r &&
                  (o(r, i, t[n] ? '' + t[n] : f.join(String(n))), 'name' in r || (r.name = n)),
            ...
            var e = r(5),
              ...
              c = function(t, n) {
                e.each.call(t.split(','), function(t) {
                  void 0 == n && t in i
                    ? (u[t] = i[t])
                    : t in [] && (u[t] = r(12)(Function.call, [][t], n))
                })
              }
